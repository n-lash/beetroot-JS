...
// console.log(time.changeMinutes(85));         // {h: 3, m: 48, s: 40, showTime: ƒ, changeSeconds: ƒ, …}
// console.log(time.changeMinutes(12));         // {h: 2, m: 35, s: 40, showTime: ƒ, changeSeconds: ƒ, …}

// console.log(time.changeHours(3));             // {h: 5, m: 23, s: 40, showTime: ƒ, changeSeconds: ƒ, …}
// console.log(time.changeHours(4));             // {h: 6, m: 23, s: 40, showTime: ƒ, changeSeconds: ƒ, …}
